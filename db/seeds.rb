...
Expense.create(author_id: 1, name: "Beer", amount: 30)
Expense.create(author_id: 1, name: "The grudge", amount: 10)
Expense.create(author_id: 1, name: "Dead by Daylight", amount: 10)
Expense.create(author_id: 1, name: "Pizza", amount: 12)
